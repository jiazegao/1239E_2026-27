...
void reverseEffectorIntake(int velocity = 140);
...
// ----------------- BASIC MOTOR MACROS -----------------
enum EFFECTOR_STAGES {IDLE_ANGLE, LOW_ANGLE, RIGHT_ANGLE, TOGGLE_ANGLE, HIGH_ANGLE, PIN_ANGLE};
constexpr float EFFECTOR_ANGLES[6] = {0.0, 60.0, 85.0, 105.0, 165.0, 82.5};
